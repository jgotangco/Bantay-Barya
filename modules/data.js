...
(function (window) {
  ...
  const SAMPLE_DEBTS = [
    {
      ...
      minPayment: 16500.00,
      dueDate: 'Every 15th',
      notes: '20-year fixed rate mortgage (6.75% EIR p.a.)',
    ...
    },
    {
      ...
      minPayment: 9800.00,
      dueDate: 'Every 5th',
      notes: '5-year auto loan (8.50% EIR p.a.)',
  ...
  const THEME_PALETTES = {
    ...
    default: ['#3b82f6', '#f43f5e', '#10b981', '#f59e0b', '#8b5cf6', '#06b6d4', '#ec4899', '#14b8a6', '#f97316', '#6366f1', '#84cc16', '#a855f7']
  };
