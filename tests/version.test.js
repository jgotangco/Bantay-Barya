...
test('Production JavaScript files do not contain competing CURRENT version constants', () => {
  const prodFiles = [
    ...
    path.join(__dirname, '..', 'modules', 'storage.js'),
    path.join(__dirname, '..', 'modules', 'crypto.js'),
    path.join(__dirname, '..', 'modules', 'validator.js'),
    path.join(__dirname, '..', 'modules', 'currency.js'),
